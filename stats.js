...
export default function stats() {
  ...
  let yearBoxContainer = document.createElement('div');
      yearBoxContainer.style.display = 'grid';
...
/*
for (let i=1; i<=20; i++) {
  let daysInYearBox${i} = document.createElement('div');
      daysInYearBox`${i}`.style.width = '10px';
      daysInYearBox${i}.style.height = '10px';
      daysInYearBox${i}.style.border = '1px black solid';
  
      daysInYearBox.onmouseenter = function () {
        alert(200, 2019)
      }
